									...
									<tbody>
										...
										<tr>
											...
											<td><input type="text" value="<%=fname%>"
												name="firstname" pattern="[a-zA-Z0-9@.-()#_ ]" size="25"></input></td>
										</tr>
										<tr>
											<td>Last Name:</td>
											<td><input type="text" value="<%=lname%>"
												name="lastname" pattern="[a-zA-Z0-9@.-()#_ ]" size="25"></input></td>
										</tr>
										<tr>
											<td>Visitor Name:</td>
											<td><input type="text" value="<%=uname%>"
												disabled="disabled" size="25"></input> <input type="hidden"
												value="<%=uname%>" name="username" pattern="[a-zA-Z0-9@.-()#_ ]" /></td>
										</tr>
										<!-- <tr>
											<td><span
										...
										<tr>
											<td>Email:</td>
											<td><input type="text" value="<%=email%>" name="email" pattern="[a-zA-Z0-9@.-()#_ ]"
												size="25"></input></td>
										</tr>
										<tr>
											<td>Phone Number:</td>
											<td><input type="text" value="<%=phoneno%>"
												name="phoneno" pattern="[a-zA-Z0-9@.-()#_ ]" size="25"></input></td>
										</tr>
										<tr>
											<td>Address:</td>
