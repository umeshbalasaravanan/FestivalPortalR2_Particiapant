...
<body>
	...
	<table width="80%" align="center" border="2">
		<tr>
						...
						<tr>
							...
							<table cellpadding="4" border="1">
								<tr>
									...
									<p class="style1">Firstname:  <jstlcore:out value="${visitor.firstName}"></jstlcore:out></p>
								 	<p class="style1">Lastname:  <jstlcore:out value="${visitor.lastName}"></jstlcore:out></p>
									...
									<c:if test="${visitor.address!=null}">
									<p class="style1">Address:  <jstlcore:out value="${visitor.address}"></jstlcore:out></p>
									</c:if>
									<c:if test="${visitor.address == null}">
									<p class="style1">Address:  no address provided</p>
									</c:if>
									</div>
									</td>
								</tr>
			...
			<p class="content">Enter event name to search <input type="text" name="eventname"></input>
			...
			<table class="content" width="96%" border="1" align="center">
				...
				<jstlcore:choose>
					  <jstlcore:when test="${event[6] != 0}">
						...
						<jstlcore:otherwise>
							<td width="100px" bgcolor="#CCCC99" align="center"><strong>SOLD OUT</strong></td>
						</jstlcore:otherwise>						
						</jstlcore:choose>
					</tr>
				</jstlcore:forEach>
