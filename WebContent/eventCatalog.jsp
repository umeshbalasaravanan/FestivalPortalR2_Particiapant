Fleft<%@ page contentType="text/html; charset=UTF-8"%>
...
<br/><br/><br/>
	<table width="80%" align="center" border="2">
		<tr>
			...
			<table>
				...
				<tr>
					...
					<input type="submit" value="Search"></input>
							...
							<jstlcore:if test="${allEvents !=null}">
			...
			<jstlcore:if test="${allEvents ==null}">
			  <h3>There are currently no events upcoming.  Please check back later.  Thanks for visiting the event portal!</h3>
			</jstlcore:if>
