...
function isNumeric(value) {
	...
	if (echeck(email)==false){
		alert("Invalid EmailID, please provide a valid e-mail id(xyz@abc.com)");
		return false;
	}
	if(isNumeric(phoneno)==false)
	{
		alert("Invalid Phonenumber, please provide a valid phone number(no special character only numbers)");
		return false;
	}
}
				...
				<tr>
					...
					<table align="center" border="0">
						...
						<tr>
							...
							First Name:</td><td> 
							   <input type="text" name="FIRSTNAME" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="40"></input></td> 
							
					   </tr>
					   <tr>			
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							Last Name: </td><td><input type="text" name="LASTNAME" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="40"></input></td>
							
					   </tr>
					   <tr>
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							Visitor Name:</td><td><input type="text" name="USERNAME" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="40"></input></td> 
							
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Password:</td><td><input type="password" name="PASSWORD" pattern="[a-zA-Z0-9@.-()#_ ]" size="27" maxlength="40"></input></td>
						   
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Confirm Password:</td><td><input type="password" name="CPASSWORD" pattern="[a-zA-Z0-9@.-()#_ ]" size="27" maxlength="40"></input></td>
						   
					   </tr>
					   <tr>
						   <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Email: </td><td> <input type="text" name="EMAIL" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="50"></input></td> 
						    
					   </tr>
					   <tr>
                           <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
                           Phone Number:</td><td><input type="text" name="PHONENO" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="40"></input></td>
                           
					   </tr>
					   <tr>
						   <td> Address:</td><td> <input type="text" name="ADDRESS" pattern="[a-zA-Z0-9@.-()#_ ]" size="25" maxlength="30"></input> </td>
